...
public class AutoDeleteByPKWriter implements StatementRewriter {
    ...
    public AutoDeleteByPKWriter(Class<? extends TranslatingStrategyAware> translaterClass, Class<?> type) {
