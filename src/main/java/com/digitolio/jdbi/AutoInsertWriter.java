...
public class AutoInsertWriter implements StatementRewriter {

    private Boolean initialized = false;

    private TranslateTableBean translateTableBean;

    AutoInsertGenerator sqlGenerator;

    public AutoInsertWriter(Class<? extends TranslatingStrategyAware> translaterClass, Class<?> type) {
